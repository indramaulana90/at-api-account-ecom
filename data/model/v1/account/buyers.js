 ...
 */
export const deleteBySupplierStoreId = async (params) => {
  const query = `delete from buyers where id in (select map_buyer_sellers.buyer_id from map_buyer_sellers where id in 
    (SELECT supplier_stores.map_buyer_seller_id FROM supplier_stores WHERE id = ${params.idBuyers}))`;
