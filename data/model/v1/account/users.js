...
/**
 * This function for seeding data delete by id on users table.
 * @param {Object} params object on will be inserted with:
 * @param {Number} params.userMobilePhone mobile phone from users table.
 */
export const deleteBymobilePhone = async (params) => {
  const query = {
    type: 'remove',
    table: 'public.users',
    condition: {
      mobile_phone: params.userMobilePhone,
    },
  };
