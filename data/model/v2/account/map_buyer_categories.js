...
* Modifier    :
* Domain      : account
* Description : This File for Model Seeding Data on map_buyer_categories table
*/
...
/**
 * This function for seeding data select by buyer_id on map_buyer_categories table.
 * @param {Number} buyer_id map_buyer_categories buyer_id.
 * @return {ArrayOfObject} result from db.
 */
export const selectByBuyerId = async (buyer_id) => {
  const query = {
    type: 'select',
    table: 'public.map_buyer_categories',
    condition: { buyer_id },
    limit: 5,
  };
...
/**
 * This function for seeding data insert with half params on map_buyer_categories table.
 * @param {Object} params object on will be inserted with:
 * @param {Number} params.id id from map_buyer_categories table.
...
export const insertFullParams = async (params) => {
  const query = {
    ...
    values: {
      ...
      buyer_category_id: params.buyer_category_id,
...
/**
 * This function for seeding data delete by id on map_buyer_categories table.
 */
